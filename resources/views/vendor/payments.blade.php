...
@section('content')
    ...
    <section class="ksm-box">
        <div class="ksm-box__head"><h2>Collega KMoney</h2></div>
        ...
        @else
            <form method="POST" action="{{ route('vendor.payments.kmoney.pair') }}" style="display: flex; gap: 10px; align-items: flex-end; flex-wrap: wrap;">
                @csrf
                <div class="ksm-field" style="margin: 0; flex: 0 1 360px;">
    ...
    <form class="ksm-formpage" method="POST" action="{{ route('vendor.payments.update') }}">
        @csrf @method('PUT')

        <section class="ksm-box">
            <div class="ksm-box__head"><h2>Metodi di pagamento</h2></div>
            <p class="ksm-box__hint">Le chiavi restano salvate: i campi vuoti non sovrascrivono quelle già inserite.</p>
            ...
            <div class="ksm-field">
                <span class="ksm-label">Attivi al checkout</span>
        ...
        <section class="ksm-box">
            <div class="ksm-box__head"><h2>Token KMoney</h2></div>
            <p class="ksm-box__hint">
        ...
        <section class="ksm-box">
            <div class="ksm-box__head"><h2>Stripe</h2></div>
        ...
        <section class="ksm-box">
            <div class="ksm-box__head"><h2>PayPal</h2></div>
        ...
        <section class="ksm-box ksm-formpage__wide">
            <div class="ksm-box__head"><h2>Notifiche dal gestore</h2></div>
            <p class="ksm-box__hint">
                ...
                gestore, poi riporta accanto il dato che ti restituisce.
            </p>

            <div class="ksm-formgrid ksm-formgrid--2">
                <div class="ksm-field">
                    <label class="ksm-label" for="webhook_stripe">Indirizzo per Stripe</label>
                    <input class="ksm-input" id="webhook_stripe" value="{{ $webhooks['stripe'] }}" readonly onclick="this.select()">
                ...
                <div class="ksm-field">
                    <label class="ksm-label" for="webhook_paypal">Indirizzo per PayPal</label>
                    <input class="ksm-input" id="webhook_paypal" value="{{ $webhooks['paypal'] }}" readonly onclick="this.select()">
                ...
                <div class="ksm-field">
                    <label class="ksm-label" for="webhook_kmoney">Indirizzo per KMoney</label>
                    <input class="ksm-input" id="webhook_kmoney" value="{{ $webhooks['kmoney'] }}" readonly onclick="this.select()">
