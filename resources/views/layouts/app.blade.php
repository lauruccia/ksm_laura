...
<head>
    ...
    {{-- Caveat serve solo alla scritta a mano delle aperture: la aggiungono home e vetrina (font-caveat). --}}
    ...
    <link rel="stylesheet" href="{{ asset('css/sections.css') }}?v={{ filemtime(public_path('css/sections.css')) }}">
    @stack('styles')
